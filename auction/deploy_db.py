...
INSERT INTO auction_bid (id, user_name, bid_dt, price, item_id_id) VALUES (6, 'user', '2020-07-03 01:48:11.741712+00', 3, 1400);
...
INSERT INTO auction_item (id, title, create_dt, close_dt, price, description) VALUES (14, 'Porcelain figurine "Parrot". Germany, Sitzendorf, handmade, 1918-1949gg.', '2020-07-02 08:25:17.47955+00', now() + interval '""" + str(random.randint(1, 120)) + """ hour', 410, 'Porcelain figurine of a parrot sitting on a tree. Completely handmade.');
...
INSERT INTO auction_item (id, title, create_dt, close_dt, price, description) VALUES (20, 'The sculpture "bear lying".', '2020-07-02 12:26:23.740808+00', now() + interval '""" + str(random.randint(1, 120)) + """ hour', 4000, 'Russia, 19th century. Bronze, casting, embossing, Druse quartz.');
...
INSERT INTO auction_item (id, title, create_dt, close_dt, price, description) VALUES (26, 'Desktop device of "Horse"', '2020-07-03 18:12:40.586611+00', now() + interval '""" + str(random.randint(1, 120)) + """ hour', 2000, 'Desktop device of "Horse". Includes pencil holders, a box. there is a plaque with the inscription in Georgian, dated 1935.');
INSERT INTO auction_item (id, title, create_dt, close_dt, price, description) VALUES (27, 'Fireplace set in the art Nouveau style', '2020-07-04 09:04:43.528714+00', now() + interval '""" + str(random.randint(1, 120)) + """ hour', 2000, 'Fireplace set, consisting of a clock and pair of vases. Items decorated with images of cyclamen and floral ornament in art Nouveau style. ');
